...
class ValidatorHelper
{
     ...
     * @return \Illuminate\Contracts\Validation\Validator
     */
    public function massiveCodeValidator($data): \Illuminate\Contracts\Validation\Validator
    {
        return Validator::make($data, [
            'group_name' => 'required|string|min:1|max:254',
            'series' => 'required|string|min:1|max:100',
            'created_type' => 'required|in:auto',
            'creation_code_count' => 'required|numeric|min:1|max:1',
            'prefix' => 'exclude_if:created_type,manual|required|min:1|max:10',
            'stringType' => 'exclude_if:created_type,manual|required|in:0,1,2',
            'access_type' => 'required|in:private',
            'uuid_list' => 'required|array|min:1|max:1',
            'uuid_list.*' => 'uuid',
            'usage_limit' => 'required|numeric|min:1',
            'usage_limit_per_user' => 'required|numeric|min:1',
            'first_buy' => 'required|boolean',
