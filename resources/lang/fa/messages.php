...
return [
    ...
    'unique' => 'ویژگی :attribute با مقدار :input بایستی یکتا باشد.',
    'required_if' => 'ویژگی :attribute ضروری است.',
    'required_with' => 'ویژگی :attribute ضروری است.',
    'in' => 'مقدار :input برای ویژگی :attribute مورد تایید نیست. ',
    'array' => 'مقدار :input برای ویژگی :attribute بایستی آرایه باشد. ',
    ...
    'checkDateIntervalAndPlan' => 'ویژگی ها دارای ( پلن و بازه تاریخ شروع و پایان مشترک ) است',
    'CodeExist' => 'این کد قبلا ایجاد شده است. در صورت نیاز میتوانید ویژگی جدید به آن اضافه کنید',
    'exceptionError' => 'هنگام ایجاد رکورد در دیتابیس خطایی رخ داده',
    'countOfCodeCreation' => 'تعداد :count کد باموفقیت ایجاد شد',
    'codeQueued' => 'تعداد :count کد در صف ارسال قرار گرفت. نتیجه عملیات ایجاد کد را در بخش گزارش ایجاد میتوانید ببینید.',
    // code processing
    'cancel_date' => 'اعتبار این کد در تاریخ :date به پایان رسیده است.',
    'usage_limit' => 'سقف مجاز استفاده از این کد به پایان رسیده است.',
    'usage_limit_per_user' => 'سقف مجاز استفاده از این کد برای شما به پایان رسیده است.',
    'user_limit' => 'اجازه استفاده از این کد برای شما صادر نشده است.',
    'market_limit' => 'استفاده از این کد، بر روی اپلیکیشنی که از آن استفاده میکنید، مجاز نیست.',
    // feature processing
    ...
    'feature_not_exit' => 'ویژگی مورد نظر یافت نشد.' ,
    'deletion_failed' => '.مشکلی در حذف از دیتابیس پیش آمده، مجدد تلاش کنید',
    'deletion_successful' => 'با موفقیت حذف شد.',
    'delete_full_successful' => 'در این گروه ویژگی دیگری باقی نمانده بود.گروه، کدها و همه موارد مرتبط با این دو نیز حذف شدند.'
