...
class DiscountCodeFeaturesTest extends TestCase
{
    ...
    public function testProcessFeatures(): void
    {
        ...
        self::assertCount(10, $processFeatures[1210]);
        self::assertCount(2, $processFeatures[1211]);
        self::assertCount(2, $processFeatures[1212]);
        self::assertCount(6, $processFeatures[1213]);
        self::assertCount(2, $processFeatures[1214]);
        self::assertCount(2, $processFeatures[1245]);
        self::assertFalse($processFeatures[1210][0]['feature_status']);
        self::assertFalse($processFeatures[1210][1]['feature_status']);
        self::assertTrue($processFeatures[1210][2]['feature_status']);
        self::assertTrue($processFeatures[1210][3]['feature_status']);
        self::assertFalse($processFeatures[1210][4]['feature_status']);
        ...
        self::assertTrue($processFeatures[1213][1]['feature_status']);
